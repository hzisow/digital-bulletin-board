...
- **Admin** (small "Admin Sign In" button, bottom-right, password `REDACTED`): edit/delete **any** event, **pin** events to the top, and open the **Instagram Requests** panel (button appears in the toolbar when signed in as admin) to see which chapters asked to be featured and mark them as posted.
